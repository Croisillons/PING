...
class CodeHighlight(val colors: Colors, val projectStore: ProjectStore) : VisualTransformation {
    ...
    private fun codeString(str: String) = buildAnnotatedString {
        withStyle(SpanStyle(colors.onSecondary)) {
            ...
            addStyle(colors.primaryVariant, strFormatted, " implements ")
            addStyle(colors.primaryVariant, strFormatted, " extends ")
            ...
            addStyle(colors.secondaryVariant, strFormatted, Regex("@[a-zA-Z_]*"))
            ...
            addStyle(colors.onBackground, strFormatted, Regex("Short "))
            addStyle(colors.onBackground, strFormatted, Regex("Byte "))
            addStyle(colors.onBackground, strFormatted, Regex(" ArrayList"))
            addStyle(colors.onBackground, strFormatted, Regex(" List"))
            addStyle(colors.onBackground, strFormatted, Regex(" HashMap"))
            addStyle(colors.onBackground, strFormatted, Regex(" Map"))
            addStyle(colors.onBackground, strFormatted, Regex(" Set"))
